...
const WorkProcess = ({ id, title, description, step, font_awesome_class }) => {
    return (
        <section className="card custom-card" style={{ marginBottom: '1px' }} key={id}>
            <div className="row g-0">
                <section className="card-body d-flex">
                    <div className="col-md-2 d-flex flex-column align-items-center me-2">
                        <i className={`${font_awesome_class} mb-1 fs-1 text-primary`}></i>
                    ...
                    <section className="col-md-10">
                        <header className="d-flex justify-content-between">
                            ...
                            <div>
                                <span className="badge bg-primary align-middle">Step {step}</span>
                            </div>
                        </header>
